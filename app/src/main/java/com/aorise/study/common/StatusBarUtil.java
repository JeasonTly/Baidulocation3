...
public class StatusBarUtil {
    ...
    // TODO: 2018/7/3 4.4版本安卓能够修改状态栏颜色 但是不能修改状态栏字体颜色   6.0以上有简单方法可以修改状态栏颜色为深黑色
    ...
    /**
     * 修改状态栏为全透明   如果不需要布局向上沉浸  那么需要在布局根目录加：android:fitsSystemWindows="true"
     * @param activity
    @TargetApi(19)
    ...
    public static int StatusBarLightMode(Activity activity){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (!StatusBarUtil.setStatusBarDarkTheme(activity, true)) {
                ...
                StatusBarUtil.setStatusBarColor(activity, R.color.color_status_bar);
            }
        }
        return result;
    }
