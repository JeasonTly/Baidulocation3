...
public abstract class BaseVlayoutAdapter<T,VH extends RecyclerView.ViewHolder> extends DelegateAdapter.Adapter<VH> {
     ...
     * @param datas
     */
    public BaseVlayoutAdapter(Context context, List<T> datas){
    ...
    public BaseVlayoutAdapter(Context context, LayoutHelper layoutHelper, List<T> datas) {
        this(context,datas);
        this.mLayoutHelper = layoutHelper;
    }
    //携带虚拟布局管理器布局参数的基础构造函数
    public BaseVlayoutAdapter(Context context, LayoutHelper layoutHelper, List<T> datas, VirtualLayoutManager.LayoutParams layoutParams) {
